...
{
    public class MacdHistogramBear : DowntrendRule, IRuleInterface
    {
        public override void Compute( StockData aStockData )
        {
            ...
            if ( ( nPrevMacd4.Bullish == 1 ) &&
                ( nPrevMacd3.Bullish == 1 ) &&
                ( nPrevMacd2.Bullish == 1 ) &&
                ( nPrevMacd1.Bullish == 1 ) &&
                ( nCurMacd.Bullish == 0 ) )
            {
                this.Score = 1;
                this.Signal = true;
        ...
        {
            return "MACD Histogram 4 GREEN 1 RED";
        }
    }
}
